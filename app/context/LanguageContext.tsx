...
const translations = {
  en: {
    ...
    'event.vratam': 'Sri Venkateswara Swamy, Sri Lakshmi Ammavari, Sri Varahi Ammavari Vratam',
    ...
    'invitation.venue': 'FVMM+3JM Piduguralla, Andhra Pradesh (Near Chennu Katta Bazaar)',
  ...
  te: {
    ...
    'event.vratam': 'శ్రీ వెంకటేశ్వర స్వామి, శ్రీ లక్ష్మీ అమ్మవారి, శ్రీ వరాహి అమ్మవారి వ్రతం',
    ...
    'invitation.venue': 'FVMM+3JM పిడుగురాళ్ల, ఆంధ్రప్రదేశ్ (చెన్ను కట్ట బజార్ సమీపంలో)',
